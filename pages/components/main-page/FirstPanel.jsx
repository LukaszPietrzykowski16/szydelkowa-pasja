  ...
  return (
    <div className='flex flex-wrap justify-center align-center mt-8 mb-8 md:flex-nowrap h-screen w-full mb-20 md:mb-5'>
      <div className='parent w-4/5 pt-5'>   
        <motion.div className='div1' animate={animation1} viewport={{ once: true }}> <img src={img2.src} className="w-full rounded-lg"/> </motion.div>
        <motion.div className='div2' animate={animation2} viewport={{ once: true }}> <img src={img1.src} className="w-full rounded-lg"/> </motion.div>
