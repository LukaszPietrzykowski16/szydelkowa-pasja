  ...
  return (
    <div className='flex flex-wrap justify-center align-center mt-8 mb-8 md:flex-nowrap h-screen w-full mb-20 md:mb-5'>
      <div className='parent w-4/5 pt-5'>   
        <motion.div className='div1' animate={animation1}> <img src={img2.src} className="w-full rounded-lg"/> </motion.div>
        <motion.div className='div2' animate={animation2}> <img src={img1.src} className="w-full rounded-lg"/> </motion.div>
        <motion.div className='div3' animate={animation3} > <img src={img0.src} className="w-full rounded-lg"/> </motion.div>
      </div>
