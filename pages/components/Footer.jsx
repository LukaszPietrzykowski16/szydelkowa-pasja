...
function Footer() {
  return (
    ...
    <footer className='flex-wrap bg-gray-900 text-white flex justify-around align-center h-64 items-center md:flex-nowrap mt-6'>
      ...
      <Link href="https://www.facebook.com/profile.php?id=100063693720962"><div className='w-4'> <FontAwesomeIcon icon={faFacebook}/> </div></Link>
      </div>
